...
public class Climber extends Subsystem {
    ...
    Solenoid lifterLeft = new Solenoid( RobotMap.PCM_Module2_12V , RobotMap.CANID_Climber_L );
    Solenoid lifterRight = new Solenoid( RobotMap.PCM_Module2_12V , RobotMap.CANID_Climber_R );

    WPI_VictorSPX climbArm = new WPI_VictorSPX(6);
    WPI_VictorSPX climbWheels = new WPI_VictorSPX(7);
