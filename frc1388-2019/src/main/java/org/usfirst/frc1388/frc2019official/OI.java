...
public class OI {
    ...
    /**
     * Pulses the rumble on controller, num times.
     ...
     * @param rumbleSide The side to rumble
     * @param strength Intensity of rumble [0,1]
     */
    public rumble( XBoxController controller, RumbleType rumbleSide, double strength ) {
        controller.setRumble( rumbleSide, rumble_strength );
    }
    ...
    public void rumbleOn( XBoxController controller ) {
        rumble( controller, RumbleType.kLeftRumble, rumble_strength );
        rumble( controller, RumbleType.kRightRumble, rumble_strength );
    }
     ...
     * @param rumbleSide The side to rumble
     */
    public void rumbleOn( XBoxController controller, RumbleType rumbleSide ) {
        rumble( controller, rumbleSide, rumble_strength );
    }
    ...
    public void rumbleOff( XBoxController controller ) {
        rumble( controller, RumbleType.kLeftRumble, 0 );
        rumble( controller, RumbleType.kRightRumble, 0 );
    }
     ...
     * @param rumbleSide The side to rumble
     */
    public void rumbleOff( XBoxController controller, RumbleType rumbleSide ) {
        rumble( controller, rumbleSide, 0 );
    }
