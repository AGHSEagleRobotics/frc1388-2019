 ...
 *
 *   DifferentialDrive1388 m_drive = new DifferentialDrive1388(m_left, m_right);
 * }
 * </code></pre>
 *
 ...
 */
public class DifferentialDrive1388 extends RobotDriveBase {
  ...
  /**
   * Construct a DifferentialDrive1388.
   *
   ...
   */
  public DifferentialDrive1388(SpeedController leftMotor, SpeedController rightMotor) {
    ...
    instances++;
    setName("DifferentialDrive1388", instances);
  }
   ...
   */
  private double toUnitsPer100ms( double output ) {
    return output * m_maxOutput * 500.0 * 4096 / 600;
  }
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
    ...
    ((WPI_TalonSRX) m_leftMotor).set( ControlMode.Velocity, toUnitsPer100ms( limit(leftMotorOutput) ) );
    // m_rightMotor.set(limit(rightMotorOutput) * m_maxOutput * m_rightSideInvertMultiplier);
    ((WPI_TalonSRX) m_rightMotor).set( ControlMode.Velocity, toUnitsPer100ms( limit(rightMotorOutput) ) * m_rightSideInvertMultiplier);
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean isQuickTurn) {
    ...
    ((WPI_TalonSRX) m_leftMotor).set( ControlMode.Velocity, toUnitsPer100ms( leftMotorOutput ) );
    // m_rightMotor.set(rightMotorOutput * m_maxOutput * m_rightSideInvertMultiplier);
    ((WPI_TalonSRX) m_rightMotor).set( ControlMode.Velocity, toUnitsPer100ms( rightMotorOutput ) * m_rightSideInvertMultiplier );
  ...
  public void tankDrive(double leftSpeed, double rightSpeed, boolean squareInputs) {
    ...
    ((WPI_TalonSRX) m_leftMotor).set( ControlMode.Velocity, toUnitsPer100ms( leftSpeed ) );
    // m_rightMotor.set(rightSpeed * m_maxOutput * m_rightSideInvertMultiplier);
    ((WPI_TalonSRX) m_leftMotor).set( ControlMode.Velocity, toUnitsPer100ms( rightSpeed ) * m_rightSideInvertMultiplier );
  ...
  public String getDescription() {
    return "DifferentialDrive1388";
  }

  @Override
  public void initSendable(SendableBuilder builder) {
    builder.setSmartDashboardType("DifferentialDrive1388");
