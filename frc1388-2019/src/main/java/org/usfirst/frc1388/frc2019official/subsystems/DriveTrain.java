...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
        ...
        leftEncoder = new Encoder( RobotMap.CANID_Drivetrain_LB , RobotMap.CANID_Drivetrain_LF, true, EncodingType.k1X);
        rightEncoder = new Encoder( RobotMap.CANID_Drivetrain_RB, RobotMap.CANID_Drivetrain_RF, true, EncodingType.k1X);
