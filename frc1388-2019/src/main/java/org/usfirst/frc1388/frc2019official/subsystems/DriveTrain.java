...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
        ...
        leftFront = new WPI_TalonSRX(RobotMap.ID_Drivetrain_LF);
        rightFront = new WPI_TalonSRX(RobotMap.ID_Drivetrain_RF);
        leftBack = new WPI_VictorSPX(RobotMap.ID_Drivetrain_LB);
        rightBack = new WPI_VictorSPX(RobotMap.ID_Drivetrain_RB);
