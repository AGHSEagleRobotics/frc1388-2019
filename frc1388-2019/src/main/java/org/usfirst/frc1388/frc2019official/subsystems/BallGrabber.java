...
public class BallGrabber extends Subsystem {
    ...
    Boolean hatchStart;
    DoubleSolenoid ballGrabber = new DoubleSolenoid(2, 3); // used to represent the top actuator of the end effector
    Solenoid ejector = new Solenoid(4);
    ...
    public void initDefaultCommand() {
        ...
        ballGrabber.set( DoubleSolenoid.Value.kOff);
        ejector.set( false );
